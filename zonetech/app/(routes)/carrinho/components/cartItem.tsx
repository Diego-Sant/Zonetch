...
const CartItem: React.FC<CartItemProps> = ({ data }) => {
  ...
  return (
    <li className="flex py-6 border-b last-of-type:border-none">
        <div className="relative h-24 w-24 rounded-md overflow-hidden sm:h-48 sm:w-48 dark:brightness-95">
